import process from 'node:process';globalThis._importMeta_={url:import.meta.url,env:process.env};import { getRequestHeader, splitCookiesString, setResponseStatus, setResponseHeader, send, getRequestHeaders, getRequestHost, getRequestProtocol, defineEventHandler, setHeader, getHeader, handleCacheHeaders, createEvent, fetchWithEvent, isEvent, eventHandler, getResponseStatus, setResponseHeaders, setHeaders, sendRedirect, proxyRequest, createError, getQuery as getQuery$1, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, readBody, getResponseStatusText } from 'file:///Users/GitHub/ThreeTreePlace/threetreeplace/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { mkdirSync } from 'node:fs';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { parentPort, threadId } from 'node:worker_threads';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Users/GitHub/ThreeTreePlace/threetreeplace/node_modules/vue-bundle-renderer/dist/runtime.mjs';
...
import { withQuery, joinURL, withTrailingSlash, hasProtocol, withHttps, withoutProtocol, parseURL, withLeadingSlash, withoutTrailingSlash, withBase, getQuery, withoutBase, parsePath, parseQuery, stringifyQuery, encodePath, stringifyParsedURL, joinRelativeURL } from 'file:///Users/GitHub/ThreeTreePlace/threetreeplace/node_modules/ufo/dist/index.mjs';
...
import { createStorage, prefixStorage } from 'file:///Users/GitHub/ThreeTreePlace/threetreeplace/node_modules/unstorage/dist/index.mjs';
...
import { consola, createConsola } from 'file:///Users/GitHub/ThreeTreePlace/threetreeplace/node_modules/consola/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/GitHub/ThreeTreePlace/threetreeplace/node_modules/errx/dist/index.js';
import { isVNode, toValue, unref, version } from 'file:///Users/GitHub/ThreeTreePlace/threetreeplace/node_modules/vue/index.mjs';
import devalue from 'file:///Users/GitHub/ThreeTreePlace/threetreeplace/node_modules/@nuxt/devalue/dist/devalue.mjs';
...
const _HzvHQxwJmV = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/Users/GitHub/ThreeTreePlace/threetreeplace";
...
const _q3Ith3 = defineEventHandler(async (e) => {
...
const _e1vwh3 = defineEventHandler(async (e) => {
...
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/GitHub/ThreeTreePlace/threetreeplace/.data/kv"}));
...
const _lazy_4xOqOF = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_4xOqOF, lazy: true, middleware: false, method: undefined },
  { route: '', handler: _OUG4vg, lazy: false, middleware: true, method: undefined },
  { route: '/__site-config__/debug.json', handler: _q3Ith3, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/debug.json', handler: _e1vwh3, lazy: false, middleware: false, method: undefined },
...
const getClientManifest = () => import('file:///Users/GitHub/ThreeTreePlace/threetreeplace/docs/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
